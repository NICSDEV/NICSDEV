...
class SwiftNotice: NSObject {
    ...
    static func wait(_ imageNames: Array<UIImage> = Array<UIImage>(), timeInterval: Int = 0) -> UIWindow {
        let frame = CGRect(x: UIScreen.main.bounds.size.width/2 - 39, y: UIScreen.main.bounds.size.height/2 - 39, width: 78, height: 78)
        let window = UIWindow()
        window.backgroundColor = UIColor.clear
        let mainView = UIView()
        mainView.backgroundColor = UIColor(red:0, green:0, blue:0, alpha: 0.3)
...
//        mainView.frame = CGRect(x: 0, y: 0, width: UIScreen.main.bounds.size.width, height: UIScreen.main.bounds.size.height)
        mainView.frame = CGRect(x: 0, y: 0, width: UIScreen.main.bounds.size.width, height: UIScreen.main.bounds.size.height)
